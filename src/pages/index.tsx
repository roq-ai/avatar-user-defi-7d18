...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Avatar user defined`}</title>

        <meta
          name="description"
          content="Avatar User Defined: Tailoring Your Experience with Personalized Avatar Creation. Unleash Your Creativity, Define Your Online Presence."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhdmF0YXJ8ZW58MHx8fHwxNjk2MDYyMDk0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@sooprun?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Alex Suprun`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Avatar User Defined: Tailoring Your Experience with Personalized Avatar Creation. Unleash Your Creativity, Define Your Online Presence.`}
            </Text>
            <Box
